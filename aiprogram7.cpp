...
//	a given vertex in a given graph #include<iostream> #include<list>
...
//	A recursive function used by DFS void DFSUtil(int v, bool visited[]);
...
//	Mark all the vertices as not visited bool *visited = new bool[V];
